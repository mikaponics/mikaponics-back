...
class PurchaseValidatorFuncSerializer(serializers.Serializer):
    step_number = serializers.IntegerField(required=False)

    # STEP 1 OF 6:
    number_of_devices = serializers.IntegerField(required=False)
    ...
    billing_address_country = serializers.CharField(required=False,allow_blank=True,)
    billing_address_region = serializers.CharField(required=False,allow_blank=True,)
    billing_address_locality = serializers.CharField(required=False,allow_blank=True,)
    ...
    shipping_address_country = serializers.CharField(required=False,allow_blank=True,)
    shipping_address_region = serializers.CharField(required=False,allow_blank=True,)
    shipping_address_locality = serializers.CharField(required=False,allow_blank=True,)
