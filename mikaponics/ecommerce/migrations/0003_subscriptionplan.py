# Generated by Django 2.1.7 on 2019-03-18 02:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ecommerce', '0002_auto_20190304_0109'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='The name of this product.', max_length=31, verbose_name='Name')),
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='CAD', help_text='A positive integer in cents (or 0 for a free plan) representing how much to charge on a recurring basis.', max_digits=14, verbose_name='Amount')),
                ('interval', models.CharField(choices=[(1, 'Monthly'), (2, 'Annually')], help_text='The frequency with which a subscription should be billed.', max_length=31, verbose_name='Interval')),
                ('payment_product_id', models.CharField(help_text='The name of this product.', max_length=31, verbose_name='Payment Product ID')),
                ('payment_plan_id', models.CharField(help_text='The name of this product.', max_length=31, verbose_name='Payment Plan ID')),
                ('store', models.ForeignKey(help_text='The store this product belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions', to='ecommerce.Store')),
            ],
            options={
