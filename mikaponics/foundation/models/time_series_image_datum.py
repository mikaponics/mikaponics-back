...
class TimeSeriesImageDatumManager(models.Manager):
    def delete_all(self):
        items = TimeSeriesImageDatum.objects.all()
    ...
    #         data, was_created = TimeSeriesImageDatum.objects.get_or_create(
...
class TimeSeriesImageDatum(models.Model):
    """
    Class used to track a single `image` value per `unit of time`.
    """
    ...
    class Meta:
        ...
        verbose_name = _('Time-Series Image Datum')
        verbose_name_plural = _('Time-Series Image Data')
        default_permissions = ()
    ...
    Object Managers
    '''
    objects = TimeSeriesImageDatumManager()
    ...
    instrument = models.ForeignKey(
        ...
        blank=False,
        null=False,
        related_name="time_series_image_data",
