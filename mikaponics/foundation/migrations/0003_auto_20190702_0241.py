# Generated by Django 2.2.1 on 2019-07-02 02:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('foundation', '0002_auto_20190701_1501'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, default='', help_text='The subscription ID set by the payment merchant.', max_length=255, verbose_name='Subscription ID'),
        ),
        migrations.AddField(
            model_name='store',
            name='subscription_monthly_fee',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='CAD', help_text='The subscription monthly fee that the payment merchante will be charge the subscriptions. Please note, this value must be exactly as was set on the payment merchant.', max_digits=14, null=True, verbose_name='Subscription Monthly Fee'),
        ),
        migrations.AddField(
            model_name='store',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, default='', help_text='The display name to describe the subscription by the payment merchant on the customers financial statement.', max_length=127, verbose_name='Subscription Name'),
        ),
    ]
