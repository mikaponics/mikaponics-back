# Generated by Django 2.1.7 on 2019-04-20 23:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('foundation', '0002_invoice_tax_percent'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='invoiceitem',
            name='quantity',
            field=models.PositiveSmallIntegerField(blank=True, default=1, help_text='The number of `Products` this invoice item holds.', verbose_name='Quantity'),
        ),
        migrations.AddField(
            model_name='invoiceitem',
            name='total_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='CAD', help_text='The total price of all `Products` in this invoice item.', max_digits=14, verbose_name='Total Price'),
        ),
        migrations.AddField(
            model_name='invoiceitem',
            name='unit_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='CAD', help_text='The price of a single `Product` for this invoice item.', max_digits=14, verbose_name='Unit Price'),
        ),
        migrations.AddField(
            model_name='invoiceitem',
